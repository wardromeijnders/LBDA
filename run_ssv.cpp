             ...
             bool standard_T)
{
    ...
    {
        problem.ssv95(nPoints[point_idx],
                      fs_cont,
                      ss_bin,
                      standard_T);  // creating problem
        ...
        cout << lb << ' ' << ub << ' ' << g_xlp << ' ' << g_x_zero << ' '
             << g_x_xdef << ' ' << g_x_xlp << ' ' << g_x_plus << ' '
             << g_x_iterative << '\n';
        cout << DEF_runTime << ' ' << lshaped_runTime << ' '
             << lbda_zero_runTime << ' ' << lbda_xdef_runTime << ' '
             << lbda_xlp_runTime << ' ' << lbda_xplus_runTime << ' '
             << lbda_x_iterative_runTime << "\n\n";
    }
}
