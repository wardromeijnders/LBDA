...
{
public:
    Data(int seed = random_device{}());  // initializes d_engine with random
    ...
    vector<vector<double>> rand_unif_mat(size_t nRows,
                                         size_t nCols,
                                         int low,
                                         int high);
    vector<vector<double>> rand_gaus_mat(size_t nRows,
                                         size_t nCols,
                                         double mean,
                                         double sd);
